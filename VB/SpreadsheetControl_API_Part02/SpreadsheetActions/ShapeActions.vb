...
Namespace SpreadsheetControl_API
	Public NotInheritable Class ShapeActions
		...
		Public Shared MoveShapeAction As Action(Of IWorkbook) = AddressOf MoveShapeValue
		Public Shared RotateShapeAction As Action(Of IWorkbook) = AddressOf RotateShapeValue
...
'			#End Region ' #insertshapefromuri
		...
		Private Shared Sub MoveShapeValue(ByVal workbook As IWorkbook)
...
'			#Region "#moveshape"
			...
			Try
				...
				worksheet.Shapes(1).Move(pic.OffsetY, pic.OffsetX)
			Finally
				workbook.EndUpdate()
			End Try
'			#End Region ' #moveshape
		End Sub

		Private Shared Sub RotateShapeValue(ByVal workbook As IWorkbook)
