...
Public Class SphereMassFunction
	...
	End Sub
        ...
        Public ReadOnly Property Name() As String Implements ICustomFunction.Name
            ...
            End Get
        End Property
        Private ReadOnly Property Parameters() As ParameterInfo() Implements ICustomFunction.Parameters
            Get
                Return functionParameters
            End Get
        End Property
        Private ReadOnly Property ReturnType() As ParameterType Implements ICustomFunction.ReturnType
            Get
                Return ParameterType.Value
            End Get
        End Property
	' Reevaluate cells on every recalculation.
        Private ReadOnly Property Volatile() As Boolean Implements ICustomFunction.Volatile
            Get
                Return False
            End Get
        End Property

        Private Function Evaluate(ByVal parameters As IList(Of ParameterValue), ByVal context As EvaluationContext) As ParameterValue Implements ICustomFunction.Evaluate
        ...
        End Function
        Private Function GetName(ByVal culture As CultureInfo) As String Implements ICustomFunction.GetName
            Return functionName
        End Function
End Class
