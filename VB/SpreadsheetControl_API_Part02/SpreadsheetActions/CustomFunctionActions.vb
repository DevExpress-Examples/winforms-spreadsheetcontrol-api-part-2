...
Public Class SphereMassFunction
	...
	End Sub
        ...
        Public ReadOnly Property Name() As String Implements CustomFunction.Name
            Get
                Return functionName
            End Get
        End Property
	Private ReadOnly Property Parameters() As ParameterInfo() Implements CustomFunction.Parameters
		Get
			Return functionParameters
		End Get
	End Property
	Private ReadOnly Property ReturnType() As ParameterType Implements CustomFunction.ReturnType
		Get
			Return ParameterType.Value
		End Get
	End Property
	' Reevaluate cells on every recalculation.
	Private ReadOnly Property Volatile() As Boolean Implements CustomFunction.Volatile
		Get
			Return False
		End Get
	End Property

	Private Function Evaluate(ByVal parameters As IList(Of ParameterValue), ByVal context As EvaluationContext) As ParameterValue Implements CustomFunction.Evaluate
	...
	End Function
	Private Function GetName(ByVal culture As CultureInfo) As String Implements CustomFunction.GetName
		Return functionName
	End Function
End Class
