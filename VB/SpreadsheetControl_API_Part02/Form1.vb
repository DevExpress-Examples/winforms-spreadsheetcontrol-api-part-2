...
'#Region "ExampleNodes"
            ...
            examples(2).Groups.Add(New SpreadsheetExample("Create a table", CreateTableAction))
            examples(2).Groups.Add(New SpreadsheetExample("Apply a custom style", CustomTableStyleAction))
'#End Region
        End Sub
