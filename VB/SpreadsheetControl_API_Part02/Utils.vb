...
Namespace SpreadsheetControl_API
    ...
    Public Class SampleComparer
        ...
        Public Function Compare(ByVal a As DevExpress.Spreadsheet.CellValue, ByVal b As DevExpress.Spreadsheet.CellValue) _
            As Integer Implements IComparer(Of DevExpress.Spreadsheet.CellValue).Compare
