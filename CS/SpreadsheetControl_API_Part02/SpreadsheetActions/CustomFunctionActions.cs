...
public class SphereMassFunction : Object, ICustomFunction
{
    ...
    ParameterInfo[] ICustomFunction.Parameters { get { return functionParameters; } }
    ParameterType ICustomFunction.ReturnType { get { return ParameterType.Value; } }
    // Reevaluate cells on every recalculation.
    bool ICustomFunction.Volatile { get { return true; } }

    ParameterValue ICustomFunction.Evaluate(IList<ParameterValue> parameters, EvaluationContext context)
    {
        double radius;
        double density = 1000;
    ...
    string ICustomFunction.GetName(CultureInfo culture)
    {
        return functionName;
    }
}
